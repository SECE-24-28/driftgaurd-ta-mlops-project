        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {cases.map((useCase, i) => (
            ...
            >
               ...
               <div className="p-5 flex-1 bg-background font-mono font-bold text-muted-foreground text-lg">
                  {useCase.desc}
               </div>
               <div className="p-4 border-t-4 border-foreground bg-surface text-center font-mono font-black uppercase text-sm hover:bg-foreground hover:text-foreground transition-colors cursor-pointer">
