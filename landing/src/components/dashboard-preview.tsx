  ...
  return (
    <section className="py-24 px-4 bg-background border-b-4 border-foreground overflow-hidden">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 border-b-8 border-foreground pb-8 gap-4">
          ...
          <div className="font-mono font-black text-xl uppercase bg-primary text-background px-4 py-2 border-4 border-foreground brutal-shadow">
            FULL VISIBILITY
          </div>
        </div>

        <div className="border-4 border-foreground bg-surface brutal-shadow p-2 md:p-6">
          {/* Dashboard Header */}
            ...
            <div className="lg:col-span-3 border-4 border-foreground bg-background p-4 brutal-shadow-sm mt-4">
              ...
              <div className="font-mono space-y-3 overflow-x-auto">
                 <div className="flex items-center gap-4 text-sm md:text-base border-l-4 border-primary pl-4 py-1 min-w-[500px]">
                    ...
                    <span className="bg-primary text-background px-2 font-bold shrink-0">INFO</span>
                 ...
                 <div className="flex items-center gap-4 text-sm md:text-base border-l-4 border-green-500 pl-4 py-1 min-w-[500px]">
                    ...
                    <span className="bg-green-500 text-background px-2 font-bold shrink-0">SUCCESS</span>
                 ...
                 <div className="flex items-center gap-4 text-sm md:text-base border-l-4 border-accent pl-4 py-1 min-w-[500px]">
                    ...
                    <span className="bg-accent text-background px-2 font-bold shrink-0">JOB</span>
                 ...
                 <div className="flex items-center gap-4 text-sm md:text-base border-l-4 border-red-500 pl-4 py-1 min-w-[500px]">
                    ...
                    <span className="bg-red-500 text-background px-2 font-bold shrink-0">ALERT</span>
