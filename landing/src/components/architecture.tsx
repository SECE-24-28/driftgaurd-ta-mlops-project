...
export function Architecture() {
  ...
  return (
    <section id="architecture" className="py-24 px-4 bg-surface border-b-4 border-foreground">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <div className="inline-block bg-primary text-background font-mono font-black px-4 py-1 border-4 border-foreground brutal-shadow-sm mb-4 uppercase text-lg">
            Under the Hood
          </div>
        ...
        <div className="max-w-4xl mx-auto border-4 border-foreground bg-background p-8 brutal-shadow">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative">
            ...
            {components.slice(0, 3).map((comp, i) => (
              <motion.div 
                ...
                className="bg-surface border-4 border-foreground p-6 z-10 w-full md:w-48 text-center brutal-shadow-sm group hover:-translate-y-2 transition-transform cursor-default"
              >
                <div className="mb-4 flex justify-center">
                   <comp.icon strokeWidth={3} className={`w-12 h-12 ${comp.color} group-hover:scale-110 transition-transform`} />
                </div>
