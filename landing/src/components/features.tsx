    ...
    <section id="features" className="py-16 px-4 bg-primary/20 border-b-4 border-foreground relative">
      ...
      <div className="container mx-auto relative z-10">
        <div className="mb-6 border-b-8 border-foreground pb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <div className="font-mono font-black text-lg uppercase bg-accent text-foreground px-4 py-2 border-4 border-foreground brutal-shadow">
            EVERYTHING YOU NEED
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {features.map((feature, i) => (
            ...
            >
              ...
              <h3 className="font-mono font-black text-xl uppercase leading-tight group-hover:text-foreground">{feature.title}</h3>
            </motion.div>
          ))}
        </div>
      </div>
